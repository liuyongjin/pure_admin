...
<div class="JNPF-common-layout-center">
  ...
  <div class="JNPF-common-layout-main JNPF-flex-main">
    <div class="JNPF-common-head">
      <div>
        <el-button type="primary" icon="el-icon-plus" size="small" v-if="!isCustomer"
...
export default {
  components: {JNPFForm, pagination, JNPFTable},
  data() {
    return {
      query: {
...
<style scoped>
  .JNPF-common-layout /deep/ .el-table .el-table__cell{
    padding:12px  0 ;
  }
</style>
